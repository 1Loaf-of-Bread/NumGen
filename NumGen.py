...
parser = argparse.ArgumentParser(description='Phone Number Generating Program')
parser.add_argument('-a', '--amount', help='Set a certain amount of phone numbers to generate.', default=None)
parser.add_argument('-b', '--benchmark', help='Does 5, 10 second benchmarks of NumGen.py to see how many valid phone numbers you generate every 10 seconds.', default=False, action='store_true')
...
def listAdd():
    ...
    print(f"{Fore.WHITE}Benchmark {Fore.CYAN}{runThrough}/5 {Fore.WHITE}Complete.")
